...
def attack(char_name: str, char_class: str) -> str:
    """Расчитывает очки атаки в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Расчитывает очки защиты в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Расчитывает очки специального умения в зависимости от класса."""
    if char_class == 'warrior':
